        ...
        if(id!=-1)
        {
            ...
            else
            {
                ...
                if(type.equals("image"))
                {
                    ...
                    storageReference.child(filename).putBytes(byteArray).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
...
//                    if(type.equals("image"))
//                    {
//                    originalReference = FirebaseStorage.getInstance().getReference("images/"+filename+".png");
//                    originalReference.putFile(originalImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
//                        @Override
//                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
//                            backgroundMYSQL.execute("uploadI", id+"",type,cname,cdescription,filename);
//                            if(progressDialog.isShowing())
//                                progressDialog.dismiss();
//                            Toast.makeText(UploadActivity.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
//                        }
